...
public class RootProjectAccessor extends TypeSafeProjectDependencyFactory {
     ...
     */
    public DemoProjectDependency getDemo() { return new DemoProjectDependency(getFactory(), create(":")); }
    ...
    /**
     * Creates a project dependency on the project at path ":common-app"
     */
    public CommonAppProjectDependency getCommonApp() { return new CommonAppProjectDependency(getFactory(), create(":common-app")); }
